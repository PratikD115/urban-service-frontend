          ...
          <div className="col-12">
            ...
            <nav className="navbar navbar-expand-lg blur border-radius-xl top-0 z-index-3 shadow position-absolute my-3 py-2 mx-auto">
              <div className="container-fluid ps-2 pe-0 me-5">
                <span className="navbar-brand me-12">Local Services 😃</span>
                ...
                <div className="card text-center shadow-card rounded ">
                  ...
                  <div className="card-body bg-cover">
                    <h5 className="card-title">
                      Create Your Local Services Account
                    </h5>
                    <p className="card-text">
                      Please select your desired registration type to get
                      started with Urban Services.
                    </p>
                    <div className="mt-4">
                      <Link
                        to="/serviceProvider/registration"
                        className="btn  btn-lg hover-effect btn-dribbble me-3"
                      >
                        Serviceprovider
                      </Link>
                      <Link
                        to="/user/registration"
                        className="btn  btn-lg hover-effect btn-dribbble"
                      >
                        User
                      </Link>
                    </div>
