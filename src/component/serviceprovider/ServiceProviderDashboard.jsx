          ...
          <SupportCard>
            <CardContent>
              ...
              <Typography variant="body1" align="center">
                If you need assistance or have any questions, please refer to
                our FAQs or contact our customer support team.
              </Typography>
              <Typography variant="body1" align="center">
                <HelpButtonContainer>
                  <HelpButton variant="contained" color="primary">
                    FAQ
                  </HelpButton>
                  <HelpButton variant="contained" color="primary">
                    Support
        ...
        <Grid item xs={12} sm={6}>
          <SupportCard>
            <CardContent>
              ...
              <Typography variant="body1" align="center">
                <SocialMediaButton variant="contained" color="primary">
                  Facebook
                </SocialMediaButton>
                <SocialMediaButton variant="contained" color="primary">
                  Twitter
